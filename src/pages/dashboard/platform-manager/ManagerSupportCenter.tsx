...
const tickets = [
  ...
  {
    id: 'TKT-001231',
    subject: 'Erro ao cadastrar propriedade',
    description: 'O formulário trava ao tentar salvar uma nova propriedade.',
    ...
    messages: [
      {
        ...
        sender: 'Ana Lima',
        senderType: 'client',
        message: 'Quando tento cadastrar uma nova propriedade, o formulário trava após clicar em salvar. Já tentei várias vezes.',
