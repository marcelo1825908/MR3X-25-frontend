...
const baseNavigation = [
  ...
  { name: 'Diretor Agência', href: '/dashboard/agency-admin', icon: Crown, perm: undefined, roles: ['CEO'] },
  ...
  { name: 'Faturamento', href: '/dashboard/billing', icon: Receipt, perm: 'billing:read', roles: ['CEO', 'INDEPENDENT_OWNER'] },
  { name: 'Configuração dividida', href: '/dashboard/split-configuration', icon: Handshake, perm: undefined, roles: ['CEO', 'ADMIN', 'AGENCY_ADMIN', 'AGENCY_MANAGER', 'INDEPENDENT_OWNER'] },
